    ...
    vplots = cms.PSet(
        ...
        FatJet = cms.PSet(
            ...
            plots = cms.VPSet(
                ...
                Plot1D('particleNet_massH_Hto4b', 'particleNet_massH_Hto4b', 300, 0, 600, 'ParticleNet Higgs mass regression for H->aa->bbbb'),
                Plot1D('particleNet_massA_Hto4b', 'particleNet_massA_Hto4b', 300, 0, 300, 'ParticleNet a boson mass regression for H->aa->bbbb'),
                Plot1D('particleNet_Hto4b',       'particleNet_Hto4b',       100, 0, 1.0, 'ParticleNet mass-decorrelated tagger H->aa->bbbb vs QCD'),
                Plot1D('phi', 'phi', 20, -3.14159, 3.14159, 'phi'),
