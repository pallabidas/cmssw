...
jetTable = cms.EDProducer("SimpleCandidateFlatTableProducer",
    ...
    variables = cms.PSet(P4Vars,
        ...
        #particleNetMD_Atobb = Var("bDiscriminator('pfMassDecorrelatedParticleNetAtobbMJetTags:probAtobb')",float,doc="Mass-decorrelated ParticleNet tagger raw A->bb score.",precision=10),
        particleNetMD_probb = Var("bDiscriminator('pfMassDecorrelatedParticleNetAtobbMJetTags:probb')",float,doc="test tagger.",precision=10),
...
fatJetTable = cms.EDProducer("SimpleCandidateFlatTableProducer",
    ...
    variables = cms.PSet(P4Vars,
        jetId = Var("userInt('tightId')*2+4*userInt('tightIdLepVeto')",int,doc="Jet ID flags bit1 is loose (always false in 2017 since it does not exist), bit2 is tight, bit3 is tightLepVeto"),
        area = Var("jetArea()", float, doc="jet catchment area, for JECs",precision=10),
        charge = Var("charge()", int, doc="jet charge (integer)"),
        rawFactor = Var("1.-jecFactor('Uncorrected')",float,doc="1 - Factor to get back to raw pT",precision=6),
        CHS_pt        = Var("userFloat('ak8PFJetsCHSValueMap:pt')",                      float, doc="CHS pt",            precision=10),
        CHS_mass      = Var("userFloat('ak8PFJetsCHSValueMap:mass')",                    float, doc="CHS mass",          precision=10),
        CHS_mpruned   = Var("userFloat('ak8PFJetsCHSValueMap:ak8PFJetsCHSPrunedMass')",  float, doc="CHS pruned mass",   precision=10),
        CHS_msoftdrop = Var("userFloat('ak8PFJetsCHSValueMap:ak8PFJetsCHSSoftDropMass')",float, doc="CHS soft drop mass",precision=10),
        ...
        CHS_tau1 = Var("userFloat('ak8PFJetsCHSValueMap:NjettinessAK8CHSTau1')",float, doc="CHS Nsubjettiness (1 axis)",precision=10),
        CHS_tau2 = Var("userFloat('ak8PFJetsCHSValueMap:NjettinessAK8CHSTau2')",float, doc="CHS Nsubjettiness (2 axis)",precision=10),
        CHS_tau3 = Var("userFloat('ak8PFJetsCHSValueMap:NjettinessAK8CHSTau3')",float, doc="CHS Nsubjettiness (3 axis)",precision=10),
        CHS_tau4 = Var("userFloat('ak8PFJetsCHSValueMap:NjettinessAK8CHSTau4')",float, doc="CHS Nsubjettiness (4 axis)",precision=10),
        ...
        n2b2 = Var("userFloat('ak8PFJetsPuppiSoftDropValueMap:nb2AK8PuppiSoftDropN2')", float, doc="N2 with beta=2", precision=10),
        n3b2 = Var("userFloat('ak8PFJetsPuppiSoftDropValueMap:nb2AK8PuppiSoftDropN3')", float, doc="N3 with beta=2", precision=10),
        msoftdrop = Var("groomedMass('SoftDropPuppi')",float, doc="Corrected soft drop mass with PUPPI",precision=10),
        msoftdrop_uncorr = Var("groomedMassUncorr('SoftDropPuppi')",float, doc="Uncorrected soft drop mass with PUPPI",precision=10),
        btagDeepB = Var("?(bDiscriminator('pfDeepCSVJetTags:probb')+bDiscriminator('pfDeepCSVJetTags:probbb'))>=0?bDiscriminator('pfDeepCSVJetTags:probb')+bDiscriminator('pfDeepCSVJetTags:probbb'):-1",float,doc="DeepCSV b+bb tag discriminator",precision=10),
        btagCSVV2 = Var("bDiscriminator('pfCombinedInclusiveSecondaryVertexV2BJetTags')",float,doc=" pfCombinedInclusiveSecondaryVertexV2 b-tag discriminator (aka CSVV2)",precision=10),
        ...
        ## New ParticleNet mass regressions
        particleNet_massH_Hto4b_v00 = Var("bDiscriminator('pfParticleNetHto4bMassRegressionH00JetTags:outputH00')",float,doc="ParticleNet Higgs mass regression for H->aa->bbbb (mass regr, mode 3 [original])",precision=10),
        particleNet_massH_Hto4b_v0 = Var("bDiscriminator('pfParticleNetHto4bMassRegressionH0JetTags:outputH0')",float,doc="ParticleNet Higgs mass regression for H->aa->bbbb (mass regr, mode 3 [2nd try])",precision=10),
        particleNet_massA_Hto4b_v0 = Var("bDiscriminator('pfParticleNetHto4bMassRegressionA0JetTags:outputA0')",float,doc="ParticleNet a boson mass regression for H->aa->bbbb (mass regr, mode 3 [original])",precision=10),
        particleNet_massH_Hto4b_v1 = Var("bDiscriminator('pfParticleNetHto4bMassRegressionH1JetTags:outputH1')",float,doc="ParticleNet Higgs mass regression for H->aa->bbbb (mass regr, mode 3 [final])",precision=10),
        particleNet_massA_Hto4b_v1 = Var("bDiscriminator('pfParticleNetHto4bMassRegressionA1JetTags:outputA1')",float,doc="ParticleNet a boson mass regression for H->aa->bbbb (mass regr, mode 3 [final])",precision=10),
        ...
        ## New ParticleNet mass-decorrelated taggers
...
#puIdDisc = Var("userFloat('pileupJetId:fullDiscriminant')",float,doc="Pileup ID discriminant",precision=10),
        nConstituents = Var("numberOfDaughters()","uint8",doc="Number of particles in the jet"),
        chMultiplicity = Var("?isPFJet()?chargedMultiplicity():-1","int",doc="(Puppi-weighted) Number of charged particles in the jet"),
        neMultiplicity = Var("?isPFJet()?neutralMultiplicity():-1","int",doc="(Puppi-weighted) Number of neutral particles in the jet"),
...
subJetTable = cms.EDProducer("SimpleCandidateFlatTableProducer",
    ...
    variables = cms.PSet(P4Vars,
        ...
        n2b2 = Var("userFloat('nb2AK8PuppiSoftDropSubjets:ecfN2')", float, doc="N2 with beta=2", precision=10),
        n3b2 = Var("userFloat('nb2AK8PuppiSoftDropSubjets:ecfN3')", float, doc="N3 with beta=2", precision=10),
    )
)
...
fatJetMCTable = cms.EDProducer("SimpleCandidateFlatTableProducer",
    ...
    variables = cms.PSet(
        ...
        # nUDSHadrons = Var("jetFlavourInfo().getNumUDSHadrons()", int, doc="number of uds-hadrons"),
        # nGluons = Var("jetFlavourInfo().getNumGluons()", int, doc="number of gluons"),
        nPartons = Var("jetFlavourInfo().getPartons().size()", int, doc="number of partons"),
        hadronFlavour = Var("hadronFlavour()", int, doc="flavour from hadron ghost clustering"),
        partonFlavour = Var("partonFlavour()", int, doc="flavour from parton ghost clustering"),
