#ifndef DataFormats_L1TCalorimeterPhase2_DigitizedClusterCorrelatorTMI18_h
#define DataFormats_L1TCalorimeterPhase2_DigitizedClusterCorrelatorTMI18_h
...
namespace l1tp2 {
  ...
  class DigitizedClusterCorrelatorTMI18 {
  private:
    // Data
  ...
  public:
    DigitizedClusterCorrelatorTMI18() { clusterData = 0x0; }

    DigitizedClusterCorrelatorTMI18(ap_uint<64> data) { clusterData = data; }

    // Constructor from digitized inputs
    DigitizedClusterCorrelatorTMI18(ap_uint<12> pt,
                               ap_uint<7> eta,
                               ap_int<7> phi,
                               ap_uint<6> hoe,
                               ap_uint<6> iso,
    ...
    ap_uint<6> hoe() const { return ((clusterData >> 26) & 0x3F); }      // (four 1's) 0b1111 = 0xF
  ...
  // Collection typedef
  typedef std::vector<l1tp2::DigitizedClusterCorrelatorTMI18> DigitizedClusterCorrelatorCollectionTMI18;
