...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:output/HtoAA_addHto4b_HtoAA_MH-125_MA-20_0_test.root'),
    # fileName = cms.untracked.string('file:output/HtoAA_addHto4b_QCD_BGen_HT700to1000_0.root'),
    # fileName = cms.untracked.string('file:output/HtoAA_addHto4b_QCD_bEnr_HT700to1000_2.root'),
    # fileName = cms.untracked.string('file:output/HtoAA_addHto4b_ZJetsToQQ_HT-400to600_03_10k.root'),
    # fileName = cms.untracked.string('file:output/HtoAA_addHto4b_ZJetsToQQ_HT-600to800_0_100k.root'),
