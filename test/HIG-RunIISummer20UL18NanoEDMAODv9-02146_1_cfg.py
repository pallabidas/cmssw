...
process.NANOEDMAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:output/HIG-RunIISummer20UL18NanoEDMAODv9-02146.root'),
