...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    # fileName = cms.untracked.string('file:output/HIG-RunIISummer20UL18NanoAODv9-02146.root'),
    fileName = cms.untracked.string('file:output/HtoAA_default_HtoAA_MH-125_MA-20_0_1k.root'),
    # fileName = cms.untracked.string('file:output/HtoAA_default_QCD_BGen_HT700to1000_0_20k.root'),
    # fileName = cms.untracked.string('file:output/HtoAA_default_QCD_bEnr_HT700to1000_2_20k.root'),
    # fileName = cms.untracked.string('file:output/HtoAA_default_ZJetsToQQ_HT-400to600_03_10k.root'),
    # fileName = cms.untracked.string('file:output/HtoAA_default_ZJetsToQQ_HT-600to800_0_100k.root'),
