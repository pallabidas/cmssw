...
process.load('PhysicsTools.NanoAOD.nano_fatJets_cff')
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:output/HIG-RunIISummer20UL18NanoAODv9-02146_fatJets.root'),
...
# Automatic addition of the customisation function from PhysicsTools.NanoAOD.nano_fatJets_cff
from PhysicsTools.NanoAOD.nano_fatJets_cff import nanoAOD_customizeMC 

#call to customisation function nanoAOD_customizeMC imported from PhysicsTools.NanoAOD.nano_fatJets_cff
